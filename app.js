...
const ITEMS_DB = [
  ...
  {name:"TK-Kartoffeln",emoji:"🥔",cat:"fertig"},
  // Milch & Käse
  ...
  {name:"Proteinriegel",emoji:"🍫",cat:"snacks"},
  // Getränke (eigene Kategorie!)
  ...
  {name:"Malzkaffee",emoji:"☕",cat:"getraenke"},
  // Haushalt
  ...
  {name:"Sonnencreme",emoji:"🧴",cat:"pflege"},{name:"Mundwasser",emoji:"🦷",cat:"pflege"},
  ...
  {name:"Kaninchenfutter",emoji:"🐰",cat:"tier"},
  // Baumarkt & Garten
...
const CAT_RULES = [
  ...
  { cat:"gewuerze", words:[
    ...
    "kokosnussöl","essig","balsamico","ketchup","senf","mayo","mayonnaise","sojasoße",
    "worcester","teriyaki","sriracha","chilisoß","tomatenmark","pizzasoße","honig",
    "marmelade","konfitüre","nutella","erdnussbutter","mandelmus","tahini","agavensirup",
    "ahornsirup","zucker","vanillezucker","backpulver","natron","speisestärke",
    "brühe","suppenwürze","kokosmilch","curry","paprikapulver","oregano","zimt",
    "rosmarin","thymian","muskat","kreuzkümmel","kümmel","kardamom","kurkuma","nelken",
    "chilipulver","ingwerpulver","lorbeer","meersalz","aufstrich",
  ]},
  // Snacks & Süßwaren
  { cat:"snacks", words:[
  ...
  { cat:"haushalt", words:[
    ...
    "müllbeutel","müllsack","mülltüte","schwamm","scheuerschwamm","küchenpapier",
    "küchentuch","backpapier","alufolie","frischhaltefolie","gefrierbeutel","batterie",
    "glühbirne","leuchtmittel","weichspüler","kerze","teelicht","streichholz",
    "lufterfrischer","spülbürste","scheuermilch","reinigungstuch","einweghandschuh",
    "wäscheklammer","bügeln","haushalt",
  ]},
  // Pflege & Gesundheit
  { cat:"pflege", words:[
...
const EMOJI_MAP = [
  ...
  [["salat","rucola"],       "🥬"], [["spinat"],           "🥬"],
  [["pilz"],                 "🍄"], [["aubergine"],        "🍆"],
  [["zucchini"],             "🥒"], [["erbse","bohne"],    "🫛"],
  [["kürbis"],               "🎃"], [["ingwer"],           "🫚"],
  [["hähnchen","hühnchen","chicken","geflügel"],"🍗"],
  [["hack","faschiert"],     "🥩"], [["rind","steak","beef"],"🥩"],
  [["schwein","kotelett","schnitzel"],"🥩"],
  [["wurst","bratwurst"],    "🌭"], [["schinken"],         "🍖"],
  [["salami"],               "🍕"], [["speck","bacon"],    "🥓"],
  [["lachs"],                "🐟"], [["thunfisch","tuna"], "🐠"],
  ...
  [["tee"],                  "🍵"], [["eistee"],           "🍵"],
  [["cola","fanta","sprite","limonade","limo"],"🥤"],
  [["bier"],                 "🍺"], [["wein","sekt","prosecco","champagner"],"🍷"],
  [["energy","energydrink"], "⚡"], [["smoothie"],         "🥤"],
  [["kokoswasser"],          "🥥"],
  // Gewürze
  [["salz"],                 "🧂"], [["pfeffer"],          "🌶️"],
  [["öl","olivenöl"],        "🫒"], [["essig","balsamico"],"🍶"],
  [["ketchup"],              "🍅"], [["senf"],             "🌿"],
  [["mayo","mayonnaise"],    "🥄"], [["sojasoße"],         "🫙"],
  [["tomatenmark","pizzasoße"],"🍅"],
  [["honig"],                "🍯"], [["marmelade"],        "🍓"],
  [["nutella"],              "🍫"], [["curry","chili"],    "🌶️"],
  [["zucker"],               "🍬"], [["mehl"],             "🌾"],
  [["brühe","suppe"],        "🍲"], [["kokosmilch"],       "🥥"],
  [["erdnussbutter","mandelmus"],"🥜"],
  // Getreide
  [["nudel","pasta","spaghetti","penne","fusilli","lasagne","tortellini"],"🍝"],
  [["reis"],                 "🍚"], [["haferflocken","hafer"],"🌾"],
  [["müsli","granola"],      "🌾"], [["quinoa","couscous","bulgur"],"🌾"],
  [["cornflake"],            "🌽"], [["linse","kichererbse","bohne"],"🌾"],
  [["pizzateig","blätterteig"],"🍕"],
  // Snacks
  [["schokolade","schoki"],  "🍫"], [["chips"],            "🍟"],
  [["keks","plätzchen"],     "🍪"], [["gummibär","gummi"], "🐻"],
  [["nuss","mandel","cashew","erdnuss","pistazie"],"🥜"],
  [["popcorn"],              "🍿"], [["eis","eiscreme"],   "🍦"],
  [["bonbon"],               "🍬"], [["riegel"],           "🍫"],
  [["salzstange","cracker"], "🥨"], [["kakao"],            "☕"],
  // Haushalt
  ...
  [["tablette","kapsel","pille","medikament"],"💊"],
  [["vitamin","magnesium"],  "💊"], [["zahnbürste"],       "🪥"],
  [["watte","wattestäbchen"],"🌸"], [["tampon","binde"],   "🌸"],
  [["windel"],               "👶"], [["sonnencreme"],      "🧴"],
  // Tier
  [["hundefutter"],          "🐕"], [["katzenfutter"],     "🐈"],
  [["katzenstreu"],          "🐱"], [["leckerli","hundesnack"],"🦴"],
  [["vogelfutter","vogelkörner"],"🐦"],
  // Baumarkt
  [["blumenerde","erde","kompost"],"🌱"],
